...
dffit.loc[dffit.voltage < dffit.voltage.quantile(0.005), "voltage"] = 0
dffit.loc[dffit.voltage.quantile(0.995) < dffit.voltage, "voltage"] = 0
...
result = gmodel.fit(
    y, x=x, ampveb=0.0008, widveb=0.01, ampvol=0.0008, widvol=0.001, ampsig=0.0008, widsig=0.001, const=-0.005, ampe=0.00073, tscale=130, t0=0.0138
)  # a=0.001, b=1, c=0.001, d=1,
