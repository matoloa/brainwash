...
class Ui_mainWindow(object):
    def setupUi(self, mainWindow):
        ...
        self.scrollAreaWidgetContents_10.setGeometry(QtCore.QRect(0, 0, 191, 1170))
        ...
        self.frameToolType.setMinimumSize(QtCore.QSize(201, 81))
        ...
        self.radioButton_type_time.setGeometry(QtCore.QRect(10, 30, 82, 17))
        ...
        self.radioButton_type_train.setGeometry(QtCore.QRect(110, 30, 82, 17))
        ...
        self.radioButton_type_IO.setGeometry(QtCore.QRect(10, 50, 82, 17))
        ...
        self.radioButton_type_PP.setGeometry(QtCore.QRect(110, 50, 82, 17))
        ...
        self.frameToolXscale = QtWidgets.QFrame(self.scrollAreaWidgetContents_10)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.frameToolXscale.setMinimumSize(QtCore.QSize(201, 81))
        self.frameToolXscale.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.frameToolXscale.setFrameShadow(QtWidgets.QFrame.Raised)
        self.frameToolXscale.setObjectName("frameToolXscale")
        self.label_x_axis = QtWidgets.QLabel(self.frameToolXscale)
        self.label_x_axis.setGeometry(QtCore.QRect(10, 10, 81, 17))
        font = QtGui.QFont()
        font.setFamily("DejaVu Sans")
        font.setBold(True)
        font.setWeight(75)
        ...
        self.radioButton_xscale_sweep = QtWidgets.QRadioButton(self.frameToolXscale)
        self.radioButton_xscale_sweep.setGeometry(QtCore.QRect(10, 50, 82, 17))
        self.radioButton_xscale_sweep.setObjectName("radioButton_xscale_sweep")
        self.buttonGroup_x_axis = QtWidgets.QButtonGroup(mainWindow)
        self.buttonGroup_x_axis.setObjectName("buttonGroup_x_axis")
        self.buttonGroup_x_axis.addButton(self.radioButton_xscale_sweep)
        self.radioButton_xscale_time = QtWidgets.QRadioButton(self.frameToolXscale)
        self.radioButton_xscale_time.setGeometry(QtCore.QRect(10, 30, 82, 17))
        self.radioButton_xscale_time.setObjectName("radioButton_xscale_time")
        self.buttonGroup_x_axis.addButton(self.radioButton_xscale_time)
        self.radioButton_xscale_timestamp = QtWidgets.QRadioButton(self.frameToolXscale)
        self.radioButton_xscale_timestamp.setGeometry(QtCore.QRect(100, 30, 82, 17))
        self.radioButton_xscale_timestamp.setObjectName("radioButton_xscale_timestamp")
        self.buttonGroup_x_axis.addButton(self.radioButton_xscale_timestamp)
        self.radioButton_xscale_stim = QtWidgets.QRadioButton(self.frameToolXscale)
        self.radioButton_xscale_stim.setGeometry(QtCore.QRect(100, 50, 82, 17))
        self.radioButton_xscale_stim.setObjectName("radioButton_xscale_stim")
        self.buttonGroup_x_axis.addButton(self.radioButton_xscale_stim)
        self.pushButton_hide_x_axis = QtWidgets.QPushButton(self.frameToolXscale)
        self.pushButton_hide_x_axis.setGeometry(QtCore.QRect(150, 10, 21, 21))
        self.pushButton_hide_x_axis.setFlat(True)
        self.pushButton_hide_x_axis.setObjectName("pushButton_hide_x_axis")
        self.verticalLayout_2.addWidget(self.frameToolXscale)
    ...
    def retranslateUi(self, mainWindow):
        ...
        self.radioButton_type_IO.setText(_translate("mainWindow", "Input-Output"))
        ...
        self.radioButton_xscale_timestamp.setText(_translate("mainWindow", "Timestamp"))
        self.radioButton_xscale_stim.setText(_translate("mainWindow", "Stim"))
        self.pushButton_hide_x_axis.setText(_translate("mainWindow", "-"))
