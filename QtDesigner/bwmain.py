...
class Ui_mainWindow(object):
    def setupUi(self, mainWindow):
        ...
        self.frameToolStim.setMinimumSize(QtCore.QSize(211, 151))
        ...
        self.frameToolBin.setMinimumSize(QtCore.QSize(211, 71))
        ...
        self.frameToolFilter.setMinimumSize(QtCore.QSize(0, 61))
        ...
        self.frameToolFilterSavgol = QtWidgets.QFrame(self.verticalLayoutWidget_3)
        self.frameToolFilterSavgol.setMinimumSize(QtCore.QSize(0, 71))
        ...
        self.verticalLayoutTools.addWidget(self.frameToolFilterSavgol)
        ...
        self.frameToolXscale.setMinimumSize(QtCore.QSize(0, 81))
        ...
        self.frameToolAspect.setMinimumSize(QtCore.QSize(211, 121))
        ...
        self.frameToolAspectAmp_2 = QtWidgets.QFrame(self.verticalLayoutWidget_3)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.frameToolAspectAmp_2.sizePolicy().hasHeightForWidth())
        self.frameToolAspectAmp_2.setSizePolicy(sizePolicy)
        self.frameToolAspectAmp_2.setMinimumSize(QtCore.QSize(211, 71))
        self.frameToolAspectAmp_2.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.frameToolAspectAmp_2.setFrameShadow(QtWidgets.QFrame.Raised)
        self.frameToolAspectAmp_2.setObjectName("frameToolAspectAmp_2")
        self.lineEdit_volley_amp_halfwidth_2 = QtWidgets.QLineEdit(self.frameToolAspectAmp_2)
        self.lineEdit_volley_amp_halfwidth_2.setGeometry(QtCore.QRect(140, 30, 31, 25))
        self.lineEdit_volley_amp_halfwidth_2.setObjectName("lineEdit_volley_amp_halfwidth_2")
        self.label_volley_amp_halfwidth_2 = QtWidgets.QLabel(self.frameToolAspectAmp_2)
        self.label_volley_amp_halfwidth_2.setGeometry(QtCore.QRect(100, 30, 31, 20))
        self.label_volley_amp_halfwidth_2.setAlignment(QtCore.Qt.AlignBottom|QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft)
        self.label_volley_amp_halfwidth_2.setObjectName("label_volley_amp_halfwidth_2")
        self.lineEdit_EPSP_amp_halfwidth_2 = QtWidgets.QLineEdit(self.frameToolAspectAmp_2)
        self.lineEdit_EPSP_amp_halfwidth_2.setGeometry(QtCore.QRect(60, 30, 31, 25))
        self.lineEdit_EPSP_amp_halfwidth_2.setObjectName("lineEdit_EPSP_amp_halfwidth_2")
        self.label_EPSP_amp_halfwidth_2 = QtWidgets.QLabel(self.frameToolAspectAmp_2)
        self.label_EPSP_amp_halfwidth_2.setGeometry(QtCore.QRect(20, 30, 31, 20))
        self.label_EPSP_amp_halfwidth_2.setAlignment(QtCore.Qt.AlignBottom|QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft)
        self.label_EPSP_amp_halfwidth_2.setObjectName("label_EPSP_amp_halfwidth_2")
        self.label_header_amp_halfwidth_2 = QtWidgets.QLabel(self.frameToolAspectAmp_2)
        self.label_header_amp_halfwidth_2.setGeometry(QtCore.QRect(10, 10, 201, 17))
        font = QtGui.QFont()
        font.setFamily("DejaVu Sans")
        font.setBold(True)
        font.setWeight(75)
        self.label_header_amp_halfwidth_2.setFont(font)
        self.label_header_amp_halfwidth_2.setObjectName("label_header_amp_halfwidth_2")
        self.verticalLayoutTools.addWidget(self.frameToolAspectAmp_2)
        self.frameToolAspectAmp = QtWidgets.QFrame(self.verticalLayoutWidget_3)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.frameToolAspectAmp.setMinimumSize(QtCore.QSize(211, 71))
        ...
        self.verticalLayoutTools.addWidget(self.frameToolAspectAmp)
    ...
    def retranslateUi(self, mainWindow):
        ...
        self.label_volley_amp_halfwidth_2.setText(_translate("mainWindow", "volley"))
        self.label_EPSP_amp_halfwidth_2.setText(_translate("mainWindow", "EPSP"))
        self.label_header_amp_halfwidth_2.setText(_translate("mainWindow", "Slope width (ms)"))
