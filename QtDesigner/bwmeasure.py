...
class Ui_measure(object):
    def setupUi(self, measure):
        ...
        self.frame_measure_filter_params.setGeometry(QtCore.QRect(90, 30, 151, 101))
        self.frame_measure_filter_params.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.frame_measure_filter_params.setFrameShadow(QtWidgets.QFrame.Raised)
