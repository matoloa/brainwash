...
def build_dfoutput(df, dict_t, filter="voltage", quick=False):
    ...
    if "t_EPSP_amp" in dict_t.keys():
        ...
        if valid(t_EPSP_amp):
            ...
            print(f"build_dfoutput: EPSP_amp t={t_EPSP_amp}, w={EPSP_w}, path={'single' if EPSP_w == 0 or quick else 'groupby'}")
    ...
    if "t_volley_amp" in dict_t.keys():
        ...
        if valid(t_volley_amp):
            ...
            print(f"build_dfoutput: volley_amp t={t_volley_amp}, w={volley_w}, path={'single' if volley_w == 0 or quick else 'groupby'}")
