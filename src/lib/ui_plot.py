...
class UIplot:
    ...
    def plot_cross(
        self, label, axid, x, amp_x, amp_y, color, rec_ID, aspect=None, stim=None
    ):
    ...
    def plot_vline(
        self, label, axid, x, color, rec_ID, aspect=None, stim=None, linewidth=8
    ):
    ...
    def plot_hline(
        self, label, axid, y, color, rec_ID, aspect=None, stim=None, linewidth=1
    ):
