...
class Ui_MainWindow(QtCore.QObject):
    def setupUi(self, mainWindow):
        ...
        self.pushButton_stim_set_threshold.setGeometry(QtCore.QRect(20, 160, 41, 25))
        ...
        self.pushButton_stim_clear.setGeometry(QtCore.QRect(70, 160, 41, 25))
        ...
        self.pushButton_stim_add.setGeometry(QtCore.QRect(120, 160, 41, 25))
    ...
    def retranslateUi(self, mainWindow):
        ...
        self.pushButton_stim_clear.setText(_translate("mainWindow", "Clear"))
        ...
        self.pushButton_stim_add.setText(_translate("mainWindow", "Add"))
