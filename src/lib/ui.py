...
class UIsub(
    ...
    def editAmpHalfwidth(self, lineEdit):
        ...
        for idx_rec in uistate.list_idx_select_recs:
            ...
            if (
                lineEditName == "lineEdit_EPSP_amp_halfwidth"
                and df_t["t_EPSP_amp_halfwidth"].dtype != "float64"
            ):
                df_t["t_EPSP_amp_halfwidth"] = df_t["t_EPSP_amp_halfwidth"].astype(
                    "float64"
                )
            elif (
                lineEditName == "lineEdit_volley_amp_halfwidth"
                and df_t["t_volley_amp_halfwidth"].dtype != "float64"
            ):
                df_t["t_volley_amp_halfwidth"] = df_t["t_volley_amp_halfwidth"].astype(
                    "float64"
                )
