...
####################################################################
    ...
    Globals
        Config          (class)
        config          (singleton)
        uistate         (singleton, UIstate)
        uiplot          (singleton, UIplot)
    Custom sub-classes
        TableModel
        FileTreeSelectorModel
        FileTreeSelectorDialog
        MplCanvas
        CustomCheckBox
        ProgressBarManager
        ParseDataThread
    ...
    Misc widget sub-classes
        TableProjSub
        Filetreesub
    Mixin wiring        (inject singletons into mixin modules)
    Main class (UIsub)  (composes Ui_MainWindow + all mixins)
        ...
        Graph interface
        Mouseover + click-and-drag + zoom functions
        pyqtSlot decorators
    Root functions
        get_signals
    Mainguard
